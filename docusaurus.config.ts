    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/PackmindHub/docusaurus/tree/master/',
        },
        blog: {
      ...
      links: [
        {
          ...
          items: [
            ...
            {
              label: "Company",
              to: 'https://www.packmind.com/'
            },
            {
              label: 'Community',
              to: 'https://join.slack.com/t/promyze/shared_invite/zt-vf6asxsj-aH1RbzuoOR5DNFexeaATVQ)'
            }
          ],
        },
      ],
      copyright: `Copyright © ${new Date().getFullYear()} Packmind Hub`,
    },
    prism: {
